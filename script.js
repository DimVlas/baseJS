...
// Решение препадавателя примерно такое-же
// Отличие в том, что он 
// получает выделенные картинки перебирая глобалный массив элементов картинок
// складывает ид`ы картинок в отдельный массив  и выводин в консоль этот массив
// это логично и верно по 2 причинам:
// 1. отправляем на сервер все удаляемые картинки
// 2. удаляем картинки из DOM только после того, как получили от сервера подтверждение удаления
